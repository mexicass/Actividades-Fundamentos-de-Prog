...
public class conv_bin {
    ...
    int b1  = (num / (int)Math.pow(2,7)) % 2;
    int b2  = (num / (int)Math.pow(2,6)) % 2;
    int b3  = (num / (int)Math.pow(2,5)) % 2;
    int b4  = (num / (int)Math.pow(2,4)) % 2;
    int b5  = (num / (int)Math.pow(2,3)) % 2;
    int b6  = (num / (int)Math.pow(2,2)) % 2;
    int b7  = (num / (int)Math.pow(2,1)) % 2;
    int b8  = (num / (int)Math.pow(2,0)) % 2;
	...
	System.out.println(barravertical+ " \t\t\t" + barravertical + " \t" + b1+b2+b3+b4+b5+b6+b7+b8 + " \t " + barravertical);
